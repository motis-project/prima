...
export async function up(db) {
	...
	await db.schema
		...
		.addColumn('ticket_valid', 'boolean', (col) => col.notNull())
		.execute();
...
`.execute(db);
	...
	BEGIN
		INSERT INTO request (passengers, wheelchairs, bikes, luggage, customer, tour, ticket_code, ticket_valid)
		VALUES (p_request.passengers, p_request.wheelchairs, p_request.bikes, p_request.luggage, p_request.customer, p_tour_id, SELECT md5(random()::text), FALSE)
