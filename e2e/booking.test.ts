...
test('Boooking', async ({ page }) => {
	...
	await page
		...
		.pressSequentially('Schleife, Deutschland', { delay: 50 });
	...
	await page
		...
		.pressSequentially('Görlitz, Deutschland', { delay: 50 });
	...
	await expect(page.getByTestId('GR-TU-11-2025-03-10T18:45:00.000Z').locator('div')).toHaveClass(
		/bg-yellow-100/
	);
	await expect(page.getByTestId('GR-TU-11-2025-03-10T19:00:00.000Z').locator('div')).toHaveClass(
		/bg-orange-400/
	);
	await expect(page.getByTestId('GR-TU-11-2025-03-10T19:15:00.000Z').locator('div')).toHaveClass(
		/bg-orange-400/
	);
	await expect(page.getByTestId('GR-TU-11-2025-03-10T19:30:00.000Z').locator('div')).toHaveClass(
		/bg-orange-400/
	);
	await expect(page.getByTestId('GR-TU-11-2025-03-10T19:45:00.000Z').locator('div')).toHaveClass(
		/bg-yellow-100/
	);
	...
	await expect(page.getByTestId('GR-TU-12-2025-03-10T19:00:00.000Z').locator('div')).toHaveClass(
		/bg-yellow-100/
	);
	await expect(page.getByTestId('GR-TU-12-2025-03-10T19:15:00.000Z').locator('div')).toHaveClass(
		/bg-orange-400/
	);
	await expect(page.getByTestId('GR-TU-12-2025-03-10T19:30:00.000Z').locator('div')).toHaveClass(
		/bg-orange-400/
	);
	await expect(page.getByTestId('GR-TU-12-2025-03-10T19:45:00.000Z').locator('div')).toHaveClass(
		/bg-orange-400/
	);
	await expect(page.getByTestId('GR-TU-12-2025-03-10T20:00:00.000Z').locator('div')).toHaveClass(
		/bg-yellow-100/
	);
	...
	await expect(page.locator('#searchmask-container')).toContainText(
		'Fahrzeug Abfahrt Ankunft Kundenerschienene Kunden Taxameterstand Kosten GR-TU-1110.03.2025, 20:0510.03.2025, 20:40100.00€0.00€GR-TU-1210.03.2025, 20:1510.03.2025, 20:50100.00€0.00€'
	);
	await page.getByRole('link', { name: 'Verfügbarkeit' }).click();
	...
	await expect(page.locator('#searchmask-container')).toContainText(
		'Fahrzeug Abfahrt Ankunft Kundenerschienene Kunden Taxameterstand Kosten GR-TU-1110.03.2025, 20:0510.03.2025, 20:40100.00€0.00€'
	);
	await page.getByRole('combobox').nth(4).selectOption('1');
	await expect(page.locator('#searchmask-container')).toContainText(
		'Fahrzeug Abfahrt Ankunft Kundenerschienene Kunden Taxameterstand Kosten GR-TU-1210.03.2025, 20:1510.03.2025, 20:50100.00€0.00€'
	);
});
