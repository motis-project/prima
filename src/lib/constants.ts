...
export const PROFIT_PER_TIME = (12 * EXPECTED_AVERAGE_KM_PER_H) / HOUR;
export const COST_PER_DRIVING_TIME = (9 * EXPECTED_AVERAGE_KM_PER_H) / HOUR;
export const COST_PER_WAITING_TIME = 2000 / HOUR;
export const MINIMUM_GAIN = 0;
