...
export const AVAILABILITY_CONFIRMATION_DEADLINE_DAYS = 14;
export const AVAILABILITY_CONFIRMATION_DEADLINE = AVAILABILITY_CONFIRMATION_DEADLINE_DAYS * DAY;
...
export const AVAILABILITY_COMPENSATION_WINDOW_START = EARLIEST_SHIFT_START - HOUR;
export const AVAILABILITY_COMPENSATION_WINDOW_END = LATEST_SHIFT_END + HOUR;
export const MAXIMUM_DAILY_AVAILABILITY =
	AVAILABILITY_COMPENSATION_WINDOW_END - AVAILABILITY_COMPENSATION_WINDOW_START;
export const MAXIMUM_AVAILABILITY_IN_CONFIRMATION_DEADLINE =
	AVAILABILITY_CONFIRMATION_DEADLINE_DAYS * MAXIMUM_DAILY_AVAILABILITY;
