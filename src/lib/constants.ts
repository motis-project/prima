...
export const STATISTICS_DISTANCE_ROUNDING_M = 100;
export const STATISTICS_DURATION_ROUNDING_MS = MINUTE;
...
export const EARLIEST_SHIFT_START = 3 * HOUR;
export const LATEST_SHIFT_END = 24 * HOUR;
...
export const MIN_AVAILABILITY_FOR_COMPENSATION = 0.7;
export const MAX_AVAILABILITY_FOR_COMPENSATION = 0.95;
export const MAX_AVAILABILITY_COMPENSATION_EUROS = 150;
export const AVAILABILITY_COMPENSATION_WINDOW_START = 5 * HOUR;
export const AVAILABILITY_COMPENSATION_WINDOW_END = 23 * HOUR;
export const AVAILABILITY_COMPENSATION_DOUBLE_WINDOW_START = 18 * HOUR;
export const AVAILABILITY_COMPENSATION_DOUBLE_WINDOW_END = 23 * HOUR;
...
export const REPEATING_DAY_SHIFT = 6;
export const DETOUR_DISTANCE_SAFETY_FACTOR = 1.15;
export const LEVEL_MIN_ZOOM = 16;
