...
export const SCHEDULED_TIME_BUFFER_PICKUP = 3 * MINUTE;
export const SCHEDULED_TIME_BUFFER_DROPOFF = 15 * MINUTE;
export const MAX_PASSENGER_WAITING_TIME_PICKUP = 25 * MINUTE;
export const MAX_PASSENGER_WAITING_TIME_DROPOFF = 25 * MINUTE;
