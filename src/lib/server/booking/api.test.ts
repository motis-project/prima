...
beforeAll(async () => { await clearDatabase(); }, 5000000);
...
describe('Whitelist and Booking API Tests', () => {
  ...
  it('simple success case', async () => {
    ...
    expect(new Date(pickup.scheduledTimeStart).toISOString()).toBe(dateInXMinutes(550).toISOString());
