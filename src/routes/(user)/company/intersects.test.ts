...
describe('intersects test', () => {
	const useOldMethod = (zones: ZonePair[]) => {
		return zones.map(async (z) => (await db
			.selectFrom('zone as compulsory_area')
			.where('compulsory_area.id', '=', z.compulsory)
			.innerJoin(
				(eb) =>
					eb.selectFrom('zone').where('id', '=', z.community).selectAll().as('community'),
				(join) => join.onTrue()
			)
	...
	const noOverlaps = [{compulsory: 1, community: 34},{compulsory: 1, community: 36},{compulsory: 1, community: 37},{compulsory: 1, community: 39},{compulsory: 1, community: 40},{compulsory: 1, community: 41}];
	const oneDimensionalOverlaps = [{compulsory: 1, community: 35},{compulsory: 1, community: 38},{compulsory: 1, community: 49},{compulsory: 1, community: 57},{compulsory: 1, community: 59},{compulsory: 1, community: 68}];
	const twoDimensionalOverlaps = [{compulsory: 1, community: 7},{compulsory: 1, community: 8},{compulsory: 1, community: 9},{compulsory: 1, community: 10},{compulsory: 1, community: 11},{compulsory: 1, community: 12}];
